...
def _t(name: str, service: str, domain: ToolDomain, mutating: bool, description: str) -> ToolSpec:
    return ToolSpec(
        name=name, service=service, domain=domain, mutating=mutating, description=description
    )
...
TOOL_REGISTRY: dict[str, ToolSpec] = {
    ...
    for t in [
        ...
        _t("get_reservation", "capacity", ToolDomain.CAPACITY_READ, False, "Read one reservation"),
        # Facilities / dispatch.
        _t(
            "create_work_order",
            "facilities",
        ...
        _t("get_work_order", "facilities", ToolDomain.FACILITIES_READ, False, "Read a work order"),
        _t(
            "dispatch_responder",
            "facilities",
            ToolDomain.FACILITIES_WRITE,
