...
def _wrap(
    broker: ToolBroker, agent: AgentName, tool_name: str, payload_fn: Callable[..., dict[str, Any]]
...
def build_toolset(
    broker: ToolBroker, agent: AgentName, incident_id: str
) -> list[Callable[..., Any]]:
    ...
    def get_freezer_state(freezer_id: str) -> dict:
        ...
        """
        return _wrap(broker, agent, "get_freezer_state", lambda: {"freezer_id": freezer_id})()
    ...
    def get_equipment_history(freezer_id: str) -> dict:
        ...
        return _wrap(broker, agent, "get_equipment_history", lambda: {"freezer_id": freezer_id})()

    def get_incident_telemetry_summary() -> dict:
        """Coarse temperature summary for this incident's freezer. No reading series."""
        return _wrap(
            broker, agent, "get_incident_telemetry_summary", lambda: {"incident_id": incident_id}
        )()
    ...
    def get_destination_temperature(freezer_id: str) -> dict:
        ...
        """
        return _wrap(
            broker, agent, "get_destination_temperature", lambda: {"freezer_id": freezer_id}
        )()
    ...
    def get_container_summary(container_id: str) -> dict:
        ...
        return _wrap(
            broker, agent, "get_container_summary", lambda: {"container_id": container_id}
        )()
    ...
    def get_placement_requirements() -> dict:
        ...
        return _wrap(
            broker, agent, "get_placement_requirements", lambda: {"incident_id": incident_id}
        )()

    def get_incident_container_ids() -> dict:
        """Container identifiers scoped to this incident. Identifiers only."""
        return _wrap(
            broker, agent, "get_incident_container_ids", lambda: {"incident_id": incident_id}
        )()
    ...
    def list_qualified_destinations(required_temp_c: float = -80.0) -> dict:
        ...
        return _wrap(
            ...
            lambda: {"incident_id": incident_id, "required_temp_c": required_temp_c},
        )()
    ...
    def get_reservation(reservation_id: str) -> dict:
        ...
        return _wrap(broker, agent, "get_reservation", lambda: {"reservation_id": reservation_id})()

    def reserve_capacity(destination_freezer_id: str, placement_group_id: str, slots: int) -> dict:
        ...
        return _wrap(
            ...
            lambda: {
                ...
                "slots": slots,
                "evidence_sources": ["capacity:get_capacity", "telemetry:get_backup_freezer_state"],
            },
        )()
    ...
    def get_responder_roster(on_call_only: bool = True) -> dict:
        ...
        return _wrap(
            broker, agent, "get_responder_roster", lambda: {"on_call_only": on_call_only}
        )()
    ...
    def get_dispatch_state() -> dict:
        ...
        return _wrap(broker, agent, "get_dispatch_state", lambda: {"incident_id": incident_id})()
    ...
    def dispatch_responder(
        responder_role: str, response_phase: str, container_ids: list[str] | None = None
    ) -> dict:
    ...
    def get_custody_state() -> dict:
        ...
        return _wrap(broker, agent, "get_custody_state", lambda: {"incident_id": incident_id})()
    ...
    def reconcile_incident() -> dict:
        ...
        """
        return _wrap(broker, agent, "reconcile_incident", lambda: {"incident_id": incident_id})()
    ...
    def flag_custody_exception(
        container_id: str, reason: str, disposition: str = "UNRESOLVED"
    ) -> dict:
    ...
    def get_incident_timeline() -> dict:
        ...
        return _wrap(broker, agent, "get_incident_timeline", lambda: {"incident_id": incident_id})()
    ...
    def request_incident_transition(to_state: str, reason: str) -> dict:
        ...
        return _wrap(
            ...
            lambda: {"incident_id": incident_id, "to_state": to_state, "reason": reason},
        )()
